...
import tk.khalifa.gabungan.adapter.Adapter;
import tk.khalifa.gabungan.app.AppController;
import tk.khalifa.gabungan.data.Data;
import tk.khalifa.gabungan.helper.SQLiteHandler;
import tk.khalifa.gabungan.helper.SessionManager;
import tk.khalifa.gabungan.until.Server;
...
public class Crud extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener
    ...
    private static String url_select 	 = Server.URL + "news.php";
